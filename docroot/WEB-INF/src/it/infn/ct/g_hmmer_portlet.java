...
@author <a href="mailto:diego-rincon@javeriana.edu.co">Diego Alberto Rincón Yáñez</a>(JAVERIANA)
@author <a href="mailto:dburbano@uniandes.edu.co">Daniel Alberto Burbano Sefair</a>(UNIANDES)
@author <a href="mailto:riccardo.rotondo@garr.it">Riccardo Rotondo</a>(GARR)
@author <a href="mailto:giuseppe.larocca@ct.infn.it">Giuseppe La Rocca</a>(INFN )
****************************************************************************/
package it.infn.ct;
 ...
 */
public class g_hmmer_portlet extends GenericPortlet {        
    
    // Instantiate the logger object
    AppLogger _log = new AppLogger(g_hmmer_portlet.class);
    ...
    {         	
        ...
        _log.debug(appInitPreferences.dump());
    } // init
        ...
        throws PortletException, IOException
    {
        ...
        //----------
            ...
            _log.debug(LS+infrastructuresInformations);
            _log.info(LS+"pref_jobRequirements   : '"+appPreferences.getJobRequirements   ()+"' -> '"+newpref_jobRequirements+"'"
    ...
    */
    ...
    void submitJob(AppInput appInput) {         
		...
		String inputSandbox = appServerPath + "/WEB-INF/job/pilot_script.sh ," +
							  appServerPath + "/WEB-INF/job/hmmer-2.3.2.tar.gz ," +
							  appServerPath + "/WEB-INF/job/secuencia.fasta ," +
